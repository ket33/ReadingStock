  ...
  return (
    <>
      ...
      <main className="flex w-full max-w-[1280px] mx-auto relative flex-grow">
        ...
        <aside className="hidden lg:block w-96 shrink-0 sticky top-16 h-[calc(100vh-64px)] border-r border-outline-variant bg-surface overflow-y-auto">
          <nav className="p-6 space-y-2">
            ...
            <div className="mt-8 pt-6 px-1 border-t border-outline-variant/60">
              <StockTimeline
                news={data.news}
