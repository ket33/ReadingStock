          ...
          <>
            ...
            {rows == null ? (
              ...
              <>
                  ...
                  <table className="w-full text-sm border-collapse min-w-max">
                    <thead>
                      <tr className="border-b border-outline-variant bg-surface-container-low">
                        ...
                        <th className="text-right px-3 py-2.5 text-xs font-medium text-on-surface-variant whitespace-nowrap">전일 대비</th>
                        ...
                        return (
                          <tr key={r.stock_code}
                            ...
                            <td className={`text-right px-3 py-1.5 tabular-nums whitespace-nowrap ${
                              ...
                              {r.ret_1d != null
                                ? `${r.ret_1d > 0 ? "▲ " : r.ret_1d < 0 ? "▼ " : ""}${Math.abs(r.ret_1d).toFixed(2)}%`
                                : "—"}
                            </td>
                ...
                {/* 2행: 수익률(60%) | 업종 비율(40%) */}
                <div className="grid md:grid-cols-[3fr_2fr] gap-4 mt-6 items-stretch">
